  ...
  return (
    <>
      ...
      >
        ...
        <div
          ref={menuRef}
          className={`fixed top-0 left-0 w-2/3 h-full bg-black text-white transform -translate-x-full z-40 md:hidden`}  // Hide on md and larger
        ...
        <div className="relative z-30 flex items-center justify-between h-full px-6 bg-black bg-opacity-30">
          <div className="w-2/3 max-w-lg text-white">
            ...
            <button
              ref={buttonRef}
              onClick={toggleMenu}  // Trigger menu on button click
